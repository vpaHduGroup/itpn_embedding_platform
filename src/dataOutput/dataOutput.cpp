...
const uint32_t kOutputHeigth = 590;
...
{
    int32_t channelId = detectDataMsg->channelId;
    string windowName = "frame_" + to_string(channelId);
	...
	cv::imshow(windowName, detectDataMsg->frame[i]);
