...
class ObjectDetector:
    def __init__(self, om_path, dataset, target_size=(480, 480), conf_thresh=0.3, nms_thresh=0.35):
    ...
    def detect(self, cv_image):
        ...
        # Run inference
        outputs = self.model.infer([preprocessed_img])
...
if __name__ == "__main__":
    ann_file = '/home/HwHiAiUser/Downloads/instances_val2017_mini50.json'
    img_dir = '/home/HwHiAiUser/Downloads/val2017/val2017'
    model_path = '/home/HwHiAiUser/Downloads/model.om'
